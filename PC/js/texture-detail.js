...
textureDetailPage.prototype.setData = function () {
    this.listData = {
        'white': {
            'name': '芝士乳胶条',
            'headImg1': 'textureDetail-white-head1.png',
            'headImg2': 'textureDetail-white-head2.png',
        ...
        'gray': {
            'name': '绒纤云锦棉',
            'headImg1': 'textureDetail-gray-head1.png',
            'headImg2': 'textureDetail-gray-head2.png',
        ...
        'lightbrown': {
            'name': '白色TPE弹体',
            'headImg1': 'textureDetail-lightbrown-head1.png',
            'headImg2': 'textureDetail-lightbrown-head2.png',
        ...
        'deepred': {
            'name': '三棱荞麦壳',
            'headImg1': 'textureDetail-deepred-head1.png',
            'headImg2': 'textureDetail-deepred-head2.png',
        ...
        'deepgray': {
            'name': '竹炭软管+香木',
            'headImg1': 'textureDetail-deepgray-head1.png',
            'headImg2': 'textureDetail-deepgray-head2.png',
        ...
        'blue': {
            'name': '蓝色TPE弹性体',
            'headImg1': 'textureDetail-blue-head1.png',
            'headImg2': 'textureDetail-blue-head2.png',
        ...
        'pink': {
            'name': '粉色TPE弹性体',
            'headImg1': 'textureDetail-pink-head1.png',
            'headImg2': 'textureDetail-pink-head2.png',
...
textureDetailPage.prototype.setDataListHtml = function () {
    ...
    <!--顶部图片1-->
    htmlArr.push('<img class="texture-head1" src="./images/' + data.headImg1 + '">');
    <!--中间材质部分-->
    htmlArr.push('<div class="texture-name-wrap">');
    htmlArr.push('<img class="texture-name-img animated fadeInLeft" src="./images/' + data.textureImg + '">');
    htmlArr.push('<div class="texture-name">');
    htmlArr.push('<p class="texture-title animated fadeInUp">' + data.title + '</p>');
    htmlArr.push('<p class="texture-subtitle animated fadeInUp">' + data.subtitle + '</p>');
    htmlArr.push('<p class="texture-color animated fadeInUp">颜色 Color: ' + data.color + '</p>');
    htmlArr.push('</div>');
    htmlArr.push('</div>');
    <!--顶部图片2-->
    htmlArr.push('<img class="texture-head2" src="./images/' + data.headImg2 + '">');

    <!--介绍部分-->
    htmlArr.push('<div class="texture-text-wrap fix">');
    <!--左侧部分-->
    htmlArr.push('<div class="texture-text-left">');
    <!--硬度-->
    ...
    htmlArr.push('</div>');
    <!--右侧描述部分-->
    htmlArr.push('<div class="texture-desc hardness">');
    ...
    <!--右侧部分-->
    htmlArr.push('<div class="texture-text-right">');
    <!--特性-->
    htmlArr.push('<div class="texture-text-line">');
    <!--左侧名称部分-->
    htmlArr.push('<div class="texture-text-name">');
